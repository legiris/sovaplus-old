<?php //netteCache[01]000400a:2:{s:4:"time";s:21:"0.31140300 1370427159";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:62:"/var/www/test.lamp/web/sovaplus/sandbox/app/config/config.neon";i:2;i:1362757658;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:68:"/var/www/test.lamp/web/sovaplus/sandbox/app/config/config.local.neon";i:2;i:1362757658;}}}?><?php
// source: /var/www/test.lamp/web/sovaplus/sandbox/app/config/config.neon production
// source: /var/www/test.lamp/web/sovaplus/sandbox/app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/var/www/test.lamp/web/sovaplus/sandbox/app',
			'wwwDir' => '/var/www/test.lamp/web/sovaplus/sandbox/www',
			'debugMode' => FALSE,
			'productionMode' => TRUE,
			...
			'tempDir' => '/var/www/test.lamp/web/sovaplus/sandbox/app/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/test.lamp/web/sovaplus/sandbox/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/var/www/test.lamp/web/sovaplus/sandbox/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Application\PresenterFactory('/var/www/test.lamp/web/sovaplus/sandbox/app', $this);
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/var/www/test.lamp/web/sovaplus/sandbox/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
